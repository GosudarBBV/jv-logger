...
public class OrderServiceImpl implements OrderService {
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        Product iphone = new Product("iPhone 16", BigDecimal.valueOf(1099));
        Product macBook = new Product("MacBook Air 2024", BigDecimal.valueOf(1199));
        Product xiaomi = new Product("samsung s25", BigDecimal.valueOf(999));
